...
namespace RayTracer
{
	...
	/// FractalSum Texutre.
	/// </summary>
	public class FractalSum : BasicTexture
	{
		// *---------------------------------------*
		// FractalSum Texutre Description
		// *---------------------------------------*

		// - FractalSum Texutre class
		...
		public FractalSum(double noiseSize, double noiseModifierR, double noiseModifierG, double noiseModifierB, double noiseBrightness, int numOctaves, double c)
		{
		...
		{
			return new RGBColour(cubicNoiseSource.ScalarFractalSum(Transform(hitPoint)) * c * noiseModifierR + noiseBrightness, cubicNoiseSource.ScalarFractalSum(Transform(hitPoint)) * c * noiseModifierG + noiseBrightness, cubicNoiseSource.ScalarFractalSum(Transform(hitPoint)) * c * noiseModifierB + noiseBrightness);
		}
