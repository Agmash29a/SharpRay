...
namespace RayTracer
{
	...
	/// fBm Texutre.
	/// </summary>
	public class fBm : BasicTexture
	{
		// *---------------------------------------*
		// fBm Texutre Description
		// *---------------------------------------*
		...
		public fBm(double noiseSize, double noiseModifierR, double noiseModifierG, double noiseModifierB, double noiseBrightness, int numOctaves, double lacunarity, double gain, double c)
		{
		...
		{
			return new RGBColour(cubicNoiseSource.ScalarfBm(Transform(hitPoint)) * c * noiseModifierR + noiseBrightness, cubicNoiseSource.ScalarfBm(Transform(hitPoint)) * c * noiseModifierG + noiseBrightness, cubicNoiseSource.ScalarfBm(Transform(hitPoint)) * c * noiseModifierB + noiseBrightness);
		}
