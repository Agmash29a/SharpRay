...
{
	/// <summary>
	/// Axis Aligned Box object class.
	/// </summary>
	public class AxisAlignedBox : BasicObject
	{
		// *---------------------------------------*
		// AxisAlignedBox Description
		// *---------------------------------------*

		// - Build a 6 faced axis alighned box
		...
		public AxisAlignedBox(Vector3D p0, Vector3D p1) : base() 
		{
			kEpsilon = 0.001;
