...
namespace RayTracer
{
	...
	/// </summary>
	public class TexturedTransparent : Phong
	{		
		// *---------------------------------------*
		// Textured Transparent (Phong) material Description
		// *---------------------------------------*

		// - A Textured Transparent type material that inherits from phong
		
		// - WARNING - this material only WORKS in certain circumstances, non transparency 
		//			   only works on the VIEWING side
		...
		BasicTexture Tex;	// TransparentMap

		// *---------------------------------------*
		// Constructor
		// *---------------------------------------*

		public TexturedTransparent(BasicTexture Tex)
		{
			this.Tex = Tex;
		...
		{
			// Calculate direct shading
			RGBColour c = base.shade(s);					

			// Check Transparency map
